...
public class Symbol implements Locatable, Loggable {
	 ...
	 */
	public enum Term {
		EOF, EQU, NEQ, LTH, GTH, LEQ, GEQ, ADD, SUB, MUL, DIV, MOD, NOT, ADDR, DATA, NEW, DEL, ASSIGN, COLON, COMMA,
		SEMIC, LBRACE, RBRACE, LBRACKET, RBRACKET, LPARENTHESIS, RPARENTHESIS, VOIDCONST, BOOLCONST, CHARCONST,
		INTCONST, PTRCONST, VOID, BOOL, CHAR, INT, PTR, ARR, DO, ELSE, END, FUN, IF, THEN, TYP, VAR, WHERE, WHILE,
		IDENTIFIER,
	}
