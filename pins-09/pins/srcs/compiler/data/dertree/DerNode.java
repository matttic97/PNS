...
public class DerNode extends DerTree {
	 ...
	 */
	public enum Nont {
		Source, Decls, DeclsRest, Decl, ParDeclsEps, ParDecls, ParDeclsRest, ParDecl, BodyEps, WhereEps, Type, Expr,
		RelExpr, RelExprRest, AddExpr, AddExprRest, MulExpr, MulExprRest, PrefExpr, PstfExpr, PstfExprRest, AtomExpr,
		CallEps, ArgsEps, Args, ArgsRest, CastEps, Stmts, StmtsRest, Stmt, AssignEps, ElseEps, StmtUntil,
	};
