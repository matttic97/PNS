...
public class AbsLogger implements AbsVisitor<Object, Object> {
	...
	@Override
	public Object visit(AbsUntilStmt untilStmt, Object visArg) {
		if (logger == null)
			return null;
		logger.begElement("node");
		logger.addAttribute("label", "UntilStmt");
		untilStmt.cond.accept(this, null);
		untilStmt.stmts.accept(this, null);
		untilStmt.log(logger);
